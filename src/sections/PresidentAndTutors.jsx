    ...
    <div className="bg-[#8C0AFF] py-[89px]">
      ...
      <div className="ml-[5%] flex gap-[18px] lg:gap-[36px] overflow-x-scroll snap-both snap-mandatory pb-[14px] pr-[15px] snap-always">
        {people.map((person, index) => (
          <div
            key={index}
            className="min-w-[300px] min-h-[400px] lg:min-w-[457px] lg:min-h-[537px] max-w-[300px] max-h-[400px] lg:max-w-[457px] lg:max-h-[537px] bg-white rounded-[10px] z-10 relative snap-center shadow-[14px_12px_#520099] overflow-hidden group"
          >
